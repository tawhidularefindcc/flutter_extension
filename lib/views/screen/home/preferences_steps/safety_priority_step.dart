...
class SafetyPriorityStep extends StatelessWidget {
  const SafetyPriorityStep({
    super.key,
        ...
        Container(
          ...
          child: const Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Crime rate statistics, police reports, community\nsurveys from official national databases',
                style: TextStyle(
                  fontSize: 18,
                  height: 1.25,
